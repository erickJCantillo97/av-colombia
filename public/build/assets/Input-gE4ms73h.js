import{C as oe,D as ae,e2 as M,e3 as Ie,m as le,f as r,o as a,a as c,r as k,n as v,g as b,E as u,t as h,c as x,e4 as B,e1 as Me,eP as De,eh as Pe,f1 as ee,eL as te,f2 as ze,ew as Ke,ex as Ae,f3 as Be,dZ as Ee,ey as Re,e6 as de,eJ as Ue,e5 as H,ej as He,ek as Ne,f5 as je,eD as q,e as C,b as f,F as D,h as Y,i as Z,w as F,dU as Ge,eB as qe,ez as We,dN as he,ap as me,d as ie,aq as Ye,u as ue,T as Ze}from"./app-PeJkGPqm.js";import{c as N,a as Qe,s as Je}from"./index-BC16rgYs.js";import{s as Xe}from"./index-CldBcx2M.js";import{d as _e,c as ke,b as xe,a as et,s as tt}from"./index-3PwvjS06.js";import{b as it,s as Se,a as we}from"./index-ey1tRXXl.js";import{a as Le,r as nt,d as lt,O as be,e as ot,p as at,f as st,g as rt,s as dt,b as ut,c as ct}from"./filepond-plugin-image-preview.min-BhkpLnQy.js";import{R as Fe}from"./index-DyTnn6g2.js";import{s as pt}from"./index-C8BFiZkQ.js";import{s as ft}from"./index-ZmNpdwqL.js";import{s as ht}from"./index-DXQaKnTh.js";import{s as mt}from"./index-CymhaHh2.js";import{s as bt}from"./index-DIGrKXE_.js";import{O as gt}from"./index-BOKNpnX4.js";import{s as yt}from"./index-DYH61HNn.js";import{s as vt}from"./index-Fq1hYrlR.js";import{u as Ot}from"./useCommonUtilities-DZ_927k8.js";import"./postcss-CJm57yBj.js";var It=oe`
    .p-togglebutton {
        display: inline-flex;
        cursor: pointer;
        user-select: none;
...
`,Mt={root:"p-chip p-component",image:"p-chip-image",icon:"p-chip-icon",label:"p-chip-label",removeIcon:"p-chip-remove-icon"},Dt=ae.extend({name:"chip",style:$t,classes:Mt}),Pt={name:"BaseChip",extends:bt,props:{label:{type:[String,Number],default:null},icon:{type:String,default:null},image:{type:String,default:null},removable:{type:Boolean,default:!1},removeIcon:{type:String,default:void 0}},style:Dt,provide:function(){return{$pcChip:this,$parentInstance:this}}},Ce={name:"Chip",extends:Pt,inheritAttrs:!1,emits:["remove"],data:function(){return{visible:!0}},methods:{onKeydown:function(t){(t.key==="Enter"||t.key==="Backspace")&&this.close(t)},close:function(t){this.visible=!1,this.$emit("remove",t)}},computed:{dataP:function(){return N({removable:this.removable})}},components:{TimesCircleIcon:mt}},zt=["aria-label","data-p"],Kt=["src"];function At(e,t,i,l,o,n){return o.visible?(a(),r("div",u({key:0,class:e.cx("root"),"aria-label":e.label},e.ptmi("root"),{"data-p":n.dataP}),[k(e.$slots,"default",{},function(){return[e.image?(a(),r("img",u({key:0,src:e.image},e.ptm("image"),{class:e.cx("image")}),null,16,Kt)):e.$slots.icon?(a(),x(B(e.$slots.icon),u({key:1,class:e.cx("icon")},e.ptm("icon")),null,16,["class"])):e.icon?(a(),r("span",u({key:2,class:[e.cx("icon"),e.icon]},e.ptm("icon")),null,16)):b("",!0),e.label?(a(),r("div",u({key:3,class:e.cx("label")},e.ptm("label")),h(e.label),17)):b("",!0)]}),e.removable?k(e.$slots,"removeicon",{key:0,removeCallback:n.close,keydownCallback:n.onKeydown},function(){return[(a(),x(B(e.removeIcon?"span":"TimesCircleIcon"),u({class:[e.cx("removeIcon"),e.removeIcon],onClick:n.close,onKeydown:n.onKeydown},e.ptm("removeIcon")),null,16,["class","onClick","onKeydown"]))]}):b("",!0)],16,zt)):b("",!0)}Ce.render=At;var Bt=oe`
    .p-multiselect {
        display: inline-flex;
        cursor: pointer;
        position: relative;
