import{s as e}from"./index-DgafbpLp.js";import{B as l,o as i,f as o,r as p,A as s}from"./app-BgxyewsD.js";var r=function(n){var a=n.dt;return`
.p-iftalabel {
    display: block;
    position: relative;
}
...
`)},c={root:"p-iftalabel"},f=l.extend({name:"iftalabel",theme:r,classes:c}),b={name:"BaseIftaLabel",extends:e,style:f,provide:function(){return{$pcIftaLabel:this,$parentInstance:this}}},d={name:"IftaLabel",extends:b,inheritAttrs:!1};function u(t,n,a,m,h,v){return i(),o("span",s({class:t.cx("root")},t.ptmi("root")),[p(t.$slots,"default")],16)}d.render=u;export{d as s};
