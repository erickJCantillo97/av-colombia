...
var script$1 = {
  ...
  computed: {
    iconComponent: function iconComponent() {
      return {
        info: !this.infoIcon && script8,
        success: !this.successIcon && script6,
        warn: !this.warnIcon && script7,
        error: !this.errorIcon && script5
...
function render$1(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }, _ctx.ptm("closeIcon")), null, 16, ["class"]))], 16, _hoisted_13)), [[_directive_ripple]])], 16)) : createCommentVNode("", true)], 16))], 16);
}
