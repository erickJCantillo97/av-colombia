...
function _(l5, u5, t4) {
  var i5, o4, r4, f5 = {};
  for (r4 in u5) "key" == r4 ? i5 = u5[r4] : "ref" == r4 ? o4 = u5[r4] : f5[r4] = u5[r4];
  if (arguments.length > 2 && (f5.children = arguments.length > 3 ? n.call(arguments, 2) : t4), "function" == typeof l5 && null != l5.defaultProps) for (r4 in l5.defaultProps) void 0 === f5[r4] && (f5[r4] = l5.defaultProps[r4]);
...
function M() {
  ...
  for (i.sort(f); n3 = i.shift(); ) n3.__d && (u5 = i.length, o4 = void 0, e4 = (r4 = (t4 = n3).__v).__e, c4 = [], s5 = [], t4.__P && ((o4 = d({}, r4)).__v = r4.__v + 1, l.vnode && l.vnode(o4), O(t4.__P, o4, r4, t4.__n, t4.__P.namespaceURI, 32 & r4.__u ? [e4] : null, c4, null == e4 ? x(r4) : e4, !!(32 & r4.__u), s5), o4.__v = r4.__v, o4.__.__k[o4.__i] = o4, j(c4, o4, s5), o4.__e != e4 && C(o4)), i.length > u5 && i.sort(f));
  M.__r = 0;
}
function P(n3, l5, u5, t4, i5, o4, r4, f5, e4, c4, s5) {
  var a4, p5, y4, d5, w4, _5 = t4 && t4.__k || v, g5 = l5.length;
  for (u5.__d = e4, $(u5, l5, _5), e4 = u5.__d, a4 = 0; a4 < g5; a4++) null != (y4 = u5.__k[a4]) && (p5 = -1 === y4.__i ? h : _5[y4.__i] || h, y4.__i = a4, O(n3, y4, p5, i5, o4, r4, f5, e4, c4, s5), d5 = y4.__e, y4.ref && p5.ref != y4.ref && (p5.ref && N(p5.ref, null, y4), s5.push(y4.ref, y4.__c || d5, y4)), null == w4 && null != d5 && (w4 = d5), 65536 & y4.__u || p5.__k === y4.__k ? e4 = I(y4, e4, n3) : "function" == typeof y4.type && void 0 !== y4.__d ? e4 = y4.__d : d5 && (e4 = d5.nextSibling), y4.__d = void 0, y4.__u &= -196609);
  u5.__d = e4, u5.__e = w4;
}
function $(n3, l5, u5) {
  var t4, i5, o4, r4, f5, e4 = l5.length, c4 = u5.length, s5 = c4, a4 = 0;
  for (n3.__k = [], t4 = 0; t4 < e4; t4++) null != (i5 = l5[t4]) && "boolean" != typeof i5 && "function" != typeof i5 ? (r4 = t4 + a4, (i5 = n3.__k[t4] = "string" == typeof i5 || "number" == typeof i5 || "bigint" == typeof i5 || i5.constructor == String ? g(null, i5, null, null, null) : y(i5) ? g(b, { children: i5 }, null, null, null) : void 0 === i5.constructor && i5.__b > 0 ? g(i5.type, i5.props, i5.key, i5.ref ? i5.ref : null, i5.__v) : i5).__ = n3, i5.__b = n3.__b + 1, o4 = null, -1 !== (f5 = i5.__i = L(i5, u5, r4, s5)) && (s5--, (o4 = u5[f5]) && (o4.__u |= 131072)), null == o4 || null === o4.__v ? (-1 == f5 && a4--, "function" != typeof i5.type && (i5.__u |= 65536)) : f5 !== r4 && (f5 == r4 - 1 ? a4-- : f5 == r4 + 1 ? a4++ : (f5 > r4 ? a4-- : a4++, i5.__u |= 65536))) : i5 = n3.__k[t4] = null;
  if (s5) for (t4 = 0; t4 < c4; t4++) null != (o4 = u5[t4]) && 0 == (131072 & o4.__u) && (o4.__e == n3.__d && (n3.__d = x(o4)), V(o4, o4));
}
function I(n3, l5, u5) {
  var t4, i5;
  if ("function" == typeof n3.type) {
    for (t4 = n3.__k, i5 = 0; t4 && i5 < t4.length; i5++) t4[i5] && (t4[i5].__ = n3, l5 = I(t4[i5], l5, u5));
    return l5;
  }
  n3.__e != l5 && (l5 && n3.type && !u5.contains(l5) && (l5 = x(n3)), u5.insertBefore(n3.__e, l5 || null), l5 = n3.__e);
  do {
...
function L(n3, l5, u5, t4) {
  ...
  if (t4 > (null != e4 && 0 == (131072 & e4.__u) ? 1 : 0)) for (; r4 >= 0 || f5 < l5.length; ) {
    if (r4 >= 0) {
...
function A(n3, l5, u5, t4, i5) {
  ...
  else if ("o" === l5[0] && "n" === l5[1]) o4 = l5 !== (l5 = l5.replace(/(PointerCapture)$|Capture$/i, "$1")), l5 = l5.toLowerCase() in n3 || "onFocusOut" === l5 || "onFocusIn" === l5 ? l5.toLowerCase().slice(2) : l5.slice(2), n3.l || (n3.l = {}), n3.l[l5 + o4] = u5, u5 ? t4 ? u5.u = t4.u : (u5.u = e, n3.addEventListener(l5, o4 ? s : c, o4)) : n3.removeEventListener(l5, o4 ? s : c, o4);
  else {
...
function O(n3, u5, t4, i5, o4, r4, f5, e4, c4, s5) {
  var a4, h4, v5, p5, w4, _5, g5, m3, x4, C3, S2, M3, $2, I2, H3, L3, T4 = u5.type;
  if (void 0 !== u5.constructor) return null;
  128 & t4.__u && (c4 = !!(32 & t4.__u), r4 = [e4 = u5.__e = t4.__e]), (a4 = l.__b) && a4(u5);
  n: if ("function" == typeof T4) try {
    if (m3 = u5.props, x4 = "prototype" in T4 && T4.prototype.render, C3 = (a4 = T4.contextType) && i5[a4.__c], S2 = a4 ? C3 ? C3.props.value : a4.__ : i5, t4.__c ? g5 = (h4 = u5.__c = t4.__c).__ = h4.__E : (x4 ? u5.__c = h4 = new T4(m3, S2) : (u5.__c = h4 = new k(m3, S2), h4.constructor = T4, h4.render = q), C3 && C3.sub(h4), h4.props = m3, h4.state || (h4.state = {}), h4.context = S2, h4.__n = i5, v5 = h4.__d = true, h4.__h = [], h4._sb = []), x4 && null == h4.__s && (h4.__s = h4.state), x4 && null != T4.getDerivedStateFromProps && (h4.__s == h4.state && (h4.__s = d({}, h4.__s)), d(h4.__s, T4.getDerivedStateFromProps(m3, h4.__s))), p5 = h4.props, w4 = h4.state, h4.__v = u5, v5) x4 && null == T4.getDerivedStateFromProps && null != h4.componentWillMount && h4.componentWillMount(), x4 && null != h4.componentDidMount && h4.__h.push(h4.componentDidMount);
    else {
      if (x4 && null == T4.getDerivedStateFromProps && m3 !== p5 && null != h4.componentWillReceiveProps && h4.componentWillReceiveProps(m3, S2), !h4.__e && (null != h4.shouldComponentUpdate && false === h4.shouldComponentUpdate(m3, h4.__s, S2) || u5.__v === t4.__v)) {
        for (u5.__v !== t4.__v && (h4.props = m3, h4.state = h4.__s, h4.__d = false), u5.__e = t4.__e, u5.__k = t4.__k, u5.__k.some(function(n4) {
          n4 && (n4.__ = u5);
    ...
    if (h4.context = S2, h4.props = m3, h4.__P = n3, h4.__e = false, $2 = l.__r, I2 = 0, x4) {
      for (h4.state = h4.__s, h4.__d = false, $2 && $2(u5), a4 = h4.render(h4.props, h4.state, h4.context), H3 = 0; H3 < h4._sb.length; H3++) h4.__h.push(h4._sb[H3]);
      h4._sb = [];
    } else do {
      h4.__d = false, $2 && $2(u5), a4 = h4.render(h4.props, h4.state, h4.context), h4.state = h4.__s;
    } while (h4.__d && ++I2 < 25);
    h4.state = h4.__s, null != h4.getChildContext && (i5 = d(d({}, i5), h4.getChildContext())), x4 && !v5 && null != h4.getSnapshotBeforeUpdate && (_5 = h4.getSnapshotBeforeUpdate(p5, w4)), P(n3, y(L3 = null != a4 && a4.type === b && null == a4.key ? a4.props.children : a4) ? L3 : [L3], u5, t4, i5, o4, r4, f5, e4, c4, s5), h4.base = u5.__e, u5.__u &= -161, h4.__h.length && f5.push(h4), g5 && (h4.__E = h4.__ = null);
  } catch (n4) {
    if (u5.__v = null, c4 || null != r4) {
      for (u5.__u |= c4 ? 160 : 128; e4 && 8 === e4.nodeType && e4.nextSibling; ) e4 = e4.nextSibling;
      r4[r4.indexOf(e4)] = null, u5.__e = e4;
    } else u5.__e = t4.__e, u5.__k = t4.__k;
    l.__e(n4, u5, t4);
  }
  else null == r4 && u5.__v === t4.__v ? (u5.__k = t4.__k, u5.__e = t4.__e) : u5.__e = z(t4.__e, u5, t4, i5, o4, r4, f5, c4, s5);
  (a4 = l.diffed) && a4(u5);
}
function j(n3, u5, t4) {
  u5.__d = void 0;
...
function z(u5, t4, i5, o4, r4, f5, e4, c4, s5) {
  var a4, v5, p5, d5, _5, g5, m3, b3 = i5.props, k3 = t4.props, C3 = t4.type;
  if ("svg" === C3 ? r4 = "http://www.w3.org/2000/svg" : "math" === C3 ? r4 = "http://www.w3.org/1998/Math/MathML" : r4 || (r4 = "http://www.w3.org/1999/xhtml"), null != f5) {
    for (a4 = 0; a4 < f5.length; a4++) if ((_5 = f5[a4]) && "setAttribute" in _5 == !!C3 && (C3 ? _5.localName === C3 : 3 === _5.nodeType)) {
      u5 = _5, f5[a4] = null;
      break;
    }
  }
  if (null == u5) {
    ...
    u5 = document.createElementNS(r4, C3, k3.is && k3), c4 && (l.__m && l.__m(t4, f5), c4 = false), f5 = null;
  }
  if (null === C3) b3 === k3 || c4 && u5.data === k3 || (u5.data = k3);
  else {
    if (f5 = f5 && n.call(u5.childNodes), b3 = i5.props || h, !c4 && null != f5) for (b3 = {}, a4 = 0; a4 < u5.attributes.length; a4++) b3[(_5 = u5.attributes[a4]).name] = _5.value;
    ...
    for (a4 in k3) _5 = k3[a4], "children" == a4 ? d5 = _5 : "dangerouslySetInnerHTML" == a4 ? v5 = _5 : "value" == a4 ? g5 = _5 : "checked" == a4 ? m3 = _5 : c4 && "function" != typeof _5 || b3[a4] === _5 || A(u5, a4, _5, b3[a4], r4);
    if (v5) c4 || p5 && (v5.__html === p5.__html || v5.__html === u5.innerHTML) || (u5.innerHTML = v5.__html), t4.__k = [];
    else if (p5 && (u5.innerHTML = ""), P(u5, y(d5) ? d5 : [d5], t4, i5, o4, "foreignObject" === C3 ? "http://www.w3.org/1999/xhtml" : r4, f5, e4, f5 ? f5[0] : i5.__k && x(i5, 0), c4, s5), null != f5) for (a4 = f5.length; a4--; ) w(f5[a4]);
    c4 || (a4 = "value", "progress" === C3 && null == g5 ? u5.removeAttribute("value") : void 0 !== g5 && (g5 !== u5[a4] || "progress" === C3 && !g5 || "option" === C3 && g5 !== b3[a4]) && A(u5, a4, g5, b3[a4], r4), a4 = "checked", void 0 !== m3 && m3 !== u5[a4] && A(u5, a4, m3, b3[a4], r4));
  }
  return u5;
}
function N(n3, u5, t4) {
...
function B(u5, t4, i5) {
  var o4, r4, f5, e4;
  l.__ && l.__(u5, t4), r4 = (o4 = "function" == typeof i5) ? null : i5 && i5.__k || t4.__k, f5 = [], e4 = [], O(t4, u5 = (!o4 && i5 || t4).__k = _(b, null, [u5]), r4 || h, h, t4.namespaceURI, !o4 && i5 ? [i5] : r4 ? null : t4.firstChild ? n.call(t4.childNodes) : null, f5, !o4 && i5 ? i5 : r4 ? r4.__e : t4.firstChild, o4, e4), j(f5, u5, e4);
}
function G(n3, l5) {
...
n = v.slice, l = { __e: function(n3, l5, u5, t4) {
  ...
  var u5;
  u5 = null != this.__s && this.__s !== this.state ? this.__s : this.__s = d({}, this.state), "function" == typeof n3 && (n3 = n3(d({}, u5), this.props)), n3 && d(u5, n3), null != n3 && this.__v && (l5 && this._sb.push(l5), S(this));
...
function u2(e4, t4, n3, o4, i5, u5) {
  ...
  var p5 = { type: e4, props: l5, key: n3, ref: a4, __k: null, __: null, __b: 0, __e: null, __d: void 0, __c: null, constructor: void 0, __v: --f2, __i: -1, __u: 0, __source: i5, __self: u5 };
...
l.unmount = function(n3) {
  ...
  var u5 = L2(r4.__v), o4 = false, i5 = function() {
...
function W(n3) {
  ...
  } }), B(_(V2, { context: e4.context }, n3.__v), e4.l);
}
function P3(n3, e4) {
  var r4 = _(W, { __v: n3, i: e4 });
...
(F3.prototype = new k()).__a = function(n3) {
  ...
  return r4[0]++, function(u5) {
    var o4 = function() {
      t4.props.revealOrder ? (r4.push(u5), U(t4, n3, r4)) : u5();
    };
    e4 ? e4(o4) : o4();
  };
  ...
  "string" == typeof n3.type && function(n4) {
    ...
    for (var i5 in t4) {
      ...
      if (!("value" === i5 && "defaultValue" in t4 && null == c4 || Z && "children" === i5 && "noscript" === e4 || "class" === i5 || "className" === i5)) {
        ...
        "defaultValue" === i5 && "value" in t4 && null == t4.value ? i5 = "value" : "download" === i5 && true === c4 ? c4 = "" : "translate" === f5 && "no" === c4 ? c4 = false : "o" === f5[0] && "n" === f5[1] ? "ondoubleclick" === f5 ? i5 = "ondblclick" : "onchange" !== f5 || "input" !== e4 && "textarea" !== e4 || Y(t4.type) ? "onfocus" === f5 ? i5 = "onfocusin" : "onblur" === f5 ? i5 = "onfocusout" : B3.test(i5) && (i5 = f5) : f5 = i5 = "oninput" : o4 && z3.test(i5) ? i5 = i5.replace(H2, "-$&").toLowerCase() : null === c4 && (c4 = void 0), "oninput" === f5 && u5[i5 = f5] && (i5 = "oninputCapture"), u5[i5] = c4;
      }
    }
    ...
    })), t4.class && !t4.className ? (u5.class = t4.class, Object.defineProperty(u5, "className", nn)) : (t4.className && !t4.class || t4.class && t4.className) && (u5.class = u5.className = t4.className), n4.props = u5;
...
function AppInput() {
  ...
  const [wrapperClasses, setWrapperClasses] = h2([]);
  ...
  return u2(b, { children: u2("div", { className: wrapperClasses.join(" "), id: inputWrapperId, children: [u2("label", { for: datePickerInputId, id: datePickerLabelId, className: "sx__date-input-label", children: $app.config.label || $app.translate("Date") }), u2("input", { id: datePickerInputId, tabIndex: $app.datePickerState.isDisabled.value ? -1 : 0, name: $app.config.name || "date", "aria-describedby": datePickerLabelId, value: $app.datePickerState.inputDisplayedValue.value, "data-testid": "date-picker-input", className: "sx__date-input", onClick: handleClick, onKeyUp: handleKeyUp, type: "text" }), u2("button", { tabIndex: $app.datePickerState.isDisabled.value ? -1 : 0, "aria-label": $app.translate("Choose Date"), onKeyDown: handleButtonKeyDown, onClick: () => $app.datePickerState.open(), className: "sx__date-input-chevron-wrapper", children: u2("img", { className: "sx__date-input-chevron", src: img, alt: "" }) })] }) });
}
var DatePickerView;
...
function Chevron({ direction, onClick, buttonText, disabled = false }) {
  ...
  return u2("button", { disabled, className: "sx__chevron-wrapper sx__ripple", onMouseUp: onClick, onKeyDown: handleKeyDown, tabIndex: 0, children: u2("i", { className: `sx__chevron sx__chevron--${direction}`, children: buttonText }) });
}
function MonthViewHeader({ setYearsView }) {
  ...
  const [selectedDateMonthName, setSelectedDateMonthName] = h2(dateStringToLocalizedMonthName($app.datePickerState.datePickerDate.value));
  const [datePickerYear, setDatePickerYear] = h2(getYearFrom($app.datePickerState.datePickerDate.value));
  ...
  return u2(b, { children: u2("header", { className: "sx__date-picker__month-view-header", children: [u2(Chevron, { direction: "previous", onClick: () => setPreviousMonth(), buttonText: $app.translate("Previous month") }), u2("button", { className: "sx__date-picker__month-view-header__month-year", onClick: (event) => handleOpenYearsView(event), children: selectedDateMonthName + " " + datePickerYear }), u2(Chevron, { direction: "next", onClick: () => setNextMonth(), buttonText: $app.translate("Next month") })] }) });
}
function DayNames() {
  const $app = x2(AppContext$1);
...
function TimeIcon({ strokeColor }) {
  return u2(b, { children: u2("svg", { className: "sx__event-icon", viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [u2("g", { id: "SVGRepo_bgCarrier", "stroke-width": "0" }), u2("g", { id: "SVGRepo_tracerCarrier", "stroke-linecap": "round", "stroke-linejoin": "round" }), u2("g", { id: "SVGRepo_iconCarrier", children: [u2("path", { d: "M12 8V12L15 15", stroke: strokeColor, "stroke-width": "2", "stroke-linecap": "round" }), u2("circle", { cx: "12", cy: "12", r: "9", stroke: strokeColor, "stroke-width": "2" })] })] }) });
}
function UserIcon({ strokeColor }) {
  return u2(b, { children: u2("svg", { className: "sx__event-icon", viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [u2("g", { id: "SVGRepo_bgCarrier", "stroke-width": "0" }), u2("g", { id: "SVGRepo_tracerCarrier", "stroke-linecap": "round", "stroke-linejoin": "round" }), u2("g", { id: "SVGRepo_iconCarrier", children: [u2("path", { d: "M15 7C15 8.65685 13.6569 10 12 10C10.3431 10 9 8.65685 9 7C9 5.34315 10.3431 4 12 4C13.6569 4 15 5.34315 15 7Z", stroke: strokeColor, "stroke-width": "2" }), u2("path", { d: "M5 19.5C5 15.9101 7.91015 13 11.5 13H12.5C16.0899 13 19 15.9101 19 19.5V20C19 20.5523 18.5523 21 18 21H6C5.44772 21 5 20.5523 5 20V19.5Z", stroke: strokeColor, "stroke-width": "2" })] })] }) });
}
function LocationPinIcon({ strokeColor }) {
  return u2(b, { children: u2("svg", { className: "sx__event-icon", viewBox: "0 0 24 24", fill: "none", xmlns: "http://www.w3.org/2000/svg", children: [u2("g", { id: "SVGRepo_bgCarrier", "stroke-width": "0" }), u2("g", { id: "SVGRepo_tracerCarrier", "stroke-linecap": "round", "stroke-linejoin": "round" }), u2("g", { id: "SVGRepo_iconCarrier", children: [u2("g", { "clip-path": "url(#clip0_429_11046)", children: [u2("rect", { x: "12", y: "11", width: "0.01", height: "0.01", stroke: strokeColor, "stroke-width": "2", "stroke-linejoin": "round" }), u2("path", { d: "M12 22L17.5 16.5C20.5376 13.4624 20.5376 8.53757 17.5 5.5C14.4624 2.46244 9.53757 2.46244 6.5 5.5C3.46244 8.53757 3.46244 13.4624 6.5 16.5L12 22Z", stroke: strokeColor, "stroke-width": "2", "stroke-linejoin": "round" })] }), u2("defs", { children: u2("clipPath", { id: "clip0_429_11046", children: u2("rect", { width: "24", height: "24", fill: "white" }) }) })] })] }) });
}
...
function MonthViewWeek({ week }) {
  ...
  return u2(b, { children: u2("div", { "data-testid": DATE_PICKER_WEEK, className: "sx__date-picker__week", children: weekDays.map((weekDay) => u2("button", { tabIndex: hasFocus(weekDay) ? 0 : -1, disabled: !isDateSelectable(weekDay.day), "aria-label": getLocalizedDate($app.datePickerState.datePickerDate.value, $app.config.locale.value), className: weekDay.classes.join(" "), "data-focus": hasFocus(weekDay) ? "true" : void 0, onClick: () => selectDate(weekDay.day), onKeyDown: handleKeyDown, children: weekDay.day.getDate() })) }) });
}
function MonthView({ seatYearsView }) {
  const elementId = randomStringId();
  const $app = x2(AppContext$1);
  const [month, setMonth] = h2([]);
  const renderMonth = () => {
  ...
  return u2(b, { children: u2("div", { id: elementId, "data-testid": MONTH_VIEW, className: "sx__date-picker__month-view", children: [u2(MonthViewHeader, { setYearsView: seatYearsView }), u2(DayNames, {}), month.map((week) => u2(MonthViewWeek, { week }))] }) });
}
function YearsViewAccordion({ year, setYearAndMonth, isExpanded, expand }) {
  ...
  return u2(b, { children: u2("li", { className: isExpanded ? "sx__is-expanded" : "", children: [u2("button", { className: "sx__date-picker__years-accordion__expand-button sx__ripple--wide", onClick: () => expand(year), children: year }), isExpanded && u2("div", { className: "sx__date-picker__years-view-accordion__panel", children: yearWithDates.map((month) => u2("button", { className: "sx__date-picker__years-view-accordion__month", onClick: (event) => handleClickOnMonth(event, month), children: toLocalizedMonth(month, $app.config.locale.value) })) })] }) });
}
function YearsView({ setMonthView }) {
  ...
  const years = Array.from({ length: maxYear - minYear + 1 }, (_5, i5) => minYear + i5);
  const { year: selectedYear } = toIntegers($app.datePickerState.selectedDate.value);
  const [expandedYear, setExpandedYear] = h2(selectedYear);
  ...
  return u2(b, { children: u2("ul", { className: "sx__date-picker__years-view", "data-testid": YEARS_VIEW, children: years.map((year) => u2(YearsViewAccordion, { year, setYearAndMonth: (year2, month) => setNewDatePickerDate(year2, month), isExpanded: expandedYear === year, expand: (year2) => setExpandedYear(year2) })) }) });
}
var isScrollable = (el) => {
  if (el) {
...
function AppPopup() {
  const $app = x2(AppContext$1);
  const [datePickerView, setDatePickerView] = h2(DatePickerView.MONTH_DAYS);
  const basePopupClasses = [POPUP_CLASS_NAME, $app.config.placement];
  const [classList, setClassList] = h2(basePopupClasses);
  y2(() => {
    setClassList([
      ...basePopupClasses,
  ...
  const [fixedPositionStyle, setFixedPositionStyle] = h2(getFixedPositionStyles());
  y2(() => {
  ...
  return u2(b, { children: u2("div", { style: $app.config.teleportTo ? fixedPositionStyle : void 0, "data-testid": "date-picker-popup", className: classList.join(" "), children: datePickerView === DatePickerView.MONTH_DAYS ? u2(MonthView, { seatYearsView: () => setDatePickerView(DatePickerView.YEARS) }) : u2(YearsView, { setMonthView: () => setDatePickerView(DatePickerView.MONTH_DAYS) }) }) });
}
function AppWrapper({ $app }) {
  const initialClassList = ["sx__date-picker-wrapper"];
  const [classList, setClassList] = h2(initialClassList);
  y2(() => {
    var _a;
  ...
  if ($app.config.teleportTo)
    appPopupJSX = P3(appPopupJSX, $app.config.teleportTo);
  return u2(b, { children: u2("div", { className: classList.join(" "), children: u2(AppContext$1.Provider, { value: $app, children: [u2(AppInput, {}), $app.datePickerState.isOpen.value && appPopupJSX] }) }) });
}
var AppContext = G({});
...
function RangeHeading() {
  ...
  const [currentHeading, setCurrentHeading] = h2("");
  y2(() => {
...
function TodayButton() {
  ...
  return u2("button", { className: "sx__today-button sx__ripple", onClick: setToday, children: $app.translate("Today") });
}
function ViewSelection() {
  const $app = x2(AppContext);
  const [availableViews, setAvailableViews] = h2([]);
  y2(() => {
  ...
  const [selectedViewLabel, setSelectedViewLabel] = h2("");
  y2(() => {
  ...
  const [viewSelectionItems, setViewSelectionItems] = h2();
  const [focusedViewIndex, setFocusedViewIndex] = h2(0);
...
function ForwardBackwardNavigation() {
  ...
  const [localizedRange, setLocalizedRange] = h2("");
  useSignalEffect(() => {
  ...
  const [rangeEndMinusOneRange, setRangeEndMinusOneRange] = h2("");
  const [rangeStartPlusOneRange, setRangeStartPlusOneRange] = h2("");
  y2(() => {
    const selectedView = $app.config.views.value.find((view) => view.name === $app.calendarState.view.value);
    if (!selectedView)
      return;
  ...
  return u2(b, { children: u2("div", { className: "sx__forward-backward-navigation", "aria-label": localizedRange, "aria-live": "polite", children: [u2(Chevron, { disabled: !!($app.config.minDate.value && dateFromDateTime(rangeEndMinusOneRange) < $app.config.minDate.value), onClick: () => navigate("backwards"), direction: "previous", buttonText: $app.translate("Previous period") }), u2(Chevron, { disabled: !!($app.config.maxDate.value && dateFromDateTime(rangeStartPlusOneRange) > $app.config.maxDate.value), onClick: () => navigate("forwards"), direction: "next", buttonText: $app.translate("Next period") })] }) });
}
...
function CalendarHeader() {
  ...
  const headerContentId = h2(headerContent ? randomStringId() : void 0)[0];
  const headerContentLeftPrepend = $app.config._customComponentFns.headerContentLeftPrepend;
  const headerContentLeftPrependId = h2(headerContentLeftPrepend ? randomStringId() : void 0)[0];
  const headerContentLeftAppend = $app.config._customComponentFns.headerContentLeftAppend;
  const headerContentLeftAppendId = h2(headerContentLeftAppend ? randomStringId() : void 0)[0];
  const headerContentRightPrepend = $app.config._customComponentFns.headerContentRightPrepend;
  const headerContentRightPrependId = h2(headerContentRightPrepend ? randomStringId() : void 0)[0];
  const headerContentRightAppend = $app.config._customComponentFns.headerContentRightAppend;
  const headerContentRightAppendId = h2(headerContentRightAppend ? randomStringId() : void 0)[0];
  y2(() => {
    if (headerContent) {
  ...
  return u2("header", { className: "sx__calendar-header", "data-ccid": headerContentId, children: !headerContent && u2(b, { children: [u2("div", { className: "sx__calendar-header-content", children: [headerContentLeftPrependId && u2("div", { "data-ccid": headerContentLeftPrependId }), u2(TodayButton, {}), u2(ForwardBackwardNavigation, {}), u2(RangeHeading, {}), headerContentLeftAppendId && u2("div", { "data-ccid": headerContentLeftAppendId })] }), u2("div", { className: "sx__calendar-header-content", children: [headerContentRightPrependId && u2("div", { "data-ccid": headerContentRightPrependId }), $app.config.views.value.length > 1 && u2(ViewSelection, {}, keyForRerenderingOnLocaleChange + "-view-selection"), u2(AppWrapper, { "$app": datePickerAppSingleton }), headerContentRightAppendId && u2("div", { "data-ccid": headerContentRightAppendId })] })] }) });
}
...
function CalendarWrapper({ $app }) {
  ...
  const [currentView, setCurrentView] = h2();
  useSignalEffect(() => {
  ...
  const [previousRangeStart, setPreviousRangeStart] = h2("");
  const [transitionClass, setTransitionClass] = h2("");
  useSignalEffect(() => {
    var _a2, _b;
...
var CalendarApp = class {
  ...
  render(el) {
    B(_(CalendarWrapper, { $app: this.$app }), el);
  }
  setTheme(theme) {
...
var createDatePickerState = (config2, selectedDateParam) => {
  ...
  const inputDisplayedValue = d3(selectedDateParam || "");
  const lastValidDisplayedValue = d3(selectedDateParam || "");
  E3(() => {
    try {
...
var createCalendarEventsImpl = (events, config2) => {
...
var createInternalConfig = (config2, plugins) => {
  return new CalendarConfigBuilder().withLocale(config2.locale).withFirstDayOfWeek(config2.firstDayOfWeek).withDefaultView(config2.defaultView).withViews(config2.views).withDayBoundaries(config2.dayBoundaries).withWeekOptions(config2.weekOptions).withCalendars(config2.calendars).withPlugins(plugins).withIsDark(config2.isDark).withIsResponsive(config2.isResponsive).withCallbacks(config2.callbacks).withMinDate(config2.minDate).withMaxDate(config2.maxDate).withMonthGridOptions(config2.monthGridOptions).build();
};
var Month;
(function(Month2) {
...
var createDatePickerConfig = (config2, dateSelectionCallback) => {
  var _a;
  return new ConfigBuilder().withLocale(config2.locale).withFirstDayOfWeek(config2.firstDayOfWeek).withMin(config2.minDate).withMax(config2.maxDate).withStyle((_a = config2.datePicker) === null || _a === void 0 ? void 0 : _a.style).withPlacement(Placement.BOTTOM_END).withListeners({ onChange: dateSelectionCallback }).build();
};
...
var createCalendarAppSingleton = (config2, plugins) => {
  ...
  const calendarEvents = createCalendarEventsImpl(config2.events || [], internalConfig);
...
var PreactView = class {
  ...
  render(onElement, $app) {
    B(_(this.Component, { $app, id: this.randomId }), onElement);
  }
  destroy() {
...
var getWidthRule = (leftRule, eventWidth) => {
...
function TimeGridEvent({ calendarEvent, dayBoundariesDateTime, isCopy, setMouseDown }) {
  ...
  }, children: u2("div", { "data-ccid": customComponentId, className: "sx__time-grid-event-inner", children: [!customComponent && !hasCustomContent && u2(b, { children: [calendarEvent.title && u2("div", { className: "sx__time-grid-event-title", children: calendarEvent.title }), u2("div", { className: "sx__time-grid-event-time", children: [u2(TimeIcon, { strokeColor: eventCSSVariables.iconStroke }), getEventTime(calendarEvent.start, calendarEvent.end)] }), calendarEvent.people && calendarEvent.people.length > 0 && u2("div", { className: "sx__time-grid-event-people", children: [u2(UserIcon, { strokeColor: eventCSSVariables.iconStroke }), concatenatePeople(calendarEvent.people)] }), calendarEvent.location && u2("div", { className: "sx__time-grid-event-location", children: [u2(LocationPinIcon, { strokeColor: eventCSSVariables.iconStroke }), calendarEvent.location] })] }), hasCustomContent && u2("div", { dangerouslySetInnerHTML: {
    __html: ((_c = calendarEvent._customContent) === null || _c === void 0 ? void 0 : _c.timeGrid) || ""
  } }), $app.config.plugins.resize && !((_d = calendarEvent._options) === null || _d === void 0 ? void 0 : _d.disableResize) && u2("div", { className: "sx__time-grid-event-resize-handle", onMouseDown: startResize })] }) }), eventCopy && u2(TimeGridEvent, { calendarEvent: eventCopy, isCopy: true, setMouseDown })] });
}
...
var sortEventsByStartAndEndWithoutConsideringTime = (a4, b3) => {
  const aStart = dateFromDateTime(a4.start);
  const bStart = dateFromDateTime(b3.start);
  const aEnd = dateFromDateTime(a4.end);
  const bEnd = dateFromDateTime(b3.end);
  if (aStart === bStart) {
    if (aEnd < bEnd)
      return 1;
    if (aEnd > bEnd)
...
function TimeGridDay({ calendarEvents, date }) {
  const [mouseDownOnChild, setMouseDownOnChild] = h2(false);
  const $app = x2(AppContext);
  ...
  const [eventsWithConcurrency, setEventsWithConcurrency] = h2([]);
  y2(() => {
  ...
  const [classNames, setClassNames] = h2(baseClasses);
  useSignalEffect(() => {
...
function TimeAxis() {
  ...
  return u2(b, { children: u2("div", { className: "sx__week-grid__time-axis", children: hours.map((hour) => u2("div", { className: "sx__week-grid__hour", children: u2("span", { className: "sx__week-grid__hour-text", children: formatter.format(new Date(0, 0, 0, hour)) }) })) }) });
}
function DateAxis({ week }) {
  ...
  return u2(b, { children: u2("div", { className: "sx__week-grid__date-axis", children: week.map((date) => u2("div", { className: getClassNames(date), "data-date": toDateString$1(date), children: [u2("div", { className: "sx__week-grid__day-name", children: getDayNameShort(date, $app.config.locale.value) }), u2("div", { className: "sx__week-grid__date-number", children: date.getDate() })] })) }) });
}
...
var positionInTimeGrid = (timeGridEvents, week, $app) => {
  ...
  for (const event of timeGridEvents) {
    ...
    if (event.start >= range.start && event.end <= range.end) {
      ...
      if (timePointsFromString(timeFromStart) < $app.config.dayBoundaries.value.start) {
        date = addDays(date, -1);
      }
...
function DateGridEvent({ calendarEvent, gridRow, isCopy }) {
  ...
  }, children: [!customComponent && !hasCustomContent && u2(b, { children: [hasOverflowLeft && u2("div", { className: "sx__date-grid-event--left-overflow", style: overflowStyles }), u2("span", { className: "sx__date-grid-event-text", children: [calendarEvent.title, "  ", dateTimeStringRegex.test(calendarEvent.start) && u2("span", { className: "sx__date-grid-event-time", children: timeFn(calendarEvent.start, $app.config.locale.value) })] }), hasOverflowRight && u2("div", { className: "sx__date-grid-event--right-overflow", style: overflowStyles })] }), hasCustomContent && u2("div", { dangerouslySetInnerHTML: {
...
function DateGridDay({ calendarEvents, date }) {
  return u2("div", { className: "sx__date-grid-day", "data-date-grid-date": date, children: Object.values(calendarEvents).map((event, index) => {
    if (event === DATE_GRID_BLOCKER || !event)
      return u2("div", { className: "sx__date-grid-cell", style: { gridRow: index + 1 } });
...
var WeekWrapper = ({ $app, id }) => {
  ...
  return u2(b, { children: u2(AppContext.Provider, { value: $app, children: u2("div", { className: "sx__week-wrapper", id, children: [u2("div", { className: "sx__week-header", children: u2("div", { className: "sx__week-header-content", children: [u2(DateAxis, { week: Object.values(week).map((day) => toJSDate(day.date)) }), u2("div", { className: "sx__date-grid", "aria-label": $app.translate("Full day- and multiple day events"), children: Object.values(week).map((day) => u2(DateGridDay, { date: day.date, calendarEvents: day.dateGridEvents }, day.date)) }), u2("div", { className: "sx__week-header-border" })] }) }), u2("div", { className: "sx__week-grid", children: [u2(TimeAxis, {}), Object.values(week).map((day) => u2(TimeGridDay, { calendarEvents: day.timeGridEvents, date: day.date }, day.date))] })] }) }) });
};
...
function MonthGridEvent({ gridRow, calendarEvent, date, isFirstWeek, isLastWeek }) {
  ...
  return u2("div", { draggable: !!$app.config.plugins.dragAndDrop, "data-event-id": calendarEvent.id, "data-ccid": customComponentId, onMouseDown: (e4) => createDragStartTimeout(handleStartDrag, e4), onMouseUp: (e4) => setClickedEventIfNotDragging(calendarEvent, e4), onTouchStart: (e4) => createDragStartTimeout(handleStartDrag, e4), onTouchEnd: (e4) => setClickedEventIfNotDragging(calendarEvent, e4), onClick: handleOnClick, onKeyDown: handleKeyDown, className: classNames.join(" "), style: {
    ...
    color: customComponent ? void 0 : eventCSSVariables.color,
    backgroundColor: customComponent ? void 0 : eventCSSVariables.backgroundColor
  }, tabIndex: 0, role: "button", children: [!customComponent && !hasCustomContent && u2(b, { children: [dateTimeStringRegex.test(calendarEvent.start) && u2("div", { className: "sx__month-grid-event-time", children: timeFn(calendarEvent.start, $app.config.locale.value) }), u2("div", { className: "sx__month-grid-event-title", children: calendarEvent.title })] }), hasCustomContent && u2("div", { dangerouslySetInnerHTML: {
...
function MonthGridDay({ day, isFirstWeek, isLastWeek }) {
  ...
  const [wrapperClasses, setWrapperClasses] = h2(baseClasses);
  y2(() => {
  ...
  }, children: [u2("div", { className: "sx__month-grid-day__header", children: [isFirstWeek ? u2("div", { className: "sx__month-grid-day__header-day-name", children: getDayNameShort(dayDate, $app.config.locale.value) }) : null, u2("div", { className: dateClassNames.join(" "), children: dayDate.getDate() })] }), u2("div", { className: "sx__month-grid-day__events", children: Object.values(day.events).slice(0, $app.config.monthGridOptions.value.nEventsPerDay).map((event, index) => {
  ...
  }) }), numberOfNonDisplayedEvents > 0 ? u2("button", { className: "sx__month-grid-day__events-more sx__ripple--wide", "aria-label": getAriaLabelSingularOrPlural(numberOfNonDisplayedEvents), onClick: handleClickAdditionalEvents, children: `+ ${numberOfNonDisplayedEvents} ${getEventTranslationSingularOrPlural(numberOfNonDisplayedEvents)}` }) : null] });
}
function MonthGridWeek({ week, isFirstWeek, isLastWeek }) {
  return u2("div", { className: "sx__month-grid-week", children: week.map((day) => {
...
var viewDay = createPreactView(config$1);
var createViewDay = () => createPreactView(config$1);
...
function MonthAgendaDay({ day, isActive, setActiveDate }) {
  ...
  return u2("button", { className: dayClasses.join(" "), onClick: handleClick, "aria-label": getLocalizedDate(day.date, $app.config.locale.value), tabIndex: hasFocus(day) ? 0 : -1, "data-agenda-focus": hasFocus(day) ? "true" : void 0, onKeyDown: handleKeyDown, children: [u2("div", { children: jsDate.getDate() }), u2("div", { className: "sx__month-agenda-day__event-icons", children: day.events.slice(0, 3).map((event) => u2("div", { style: {
...
function MonthAgendaWeek({ week, setActiveDate, activeDate }) {
  return u2("div", { className: "sx__month-agenda-week", children: week.map((day, index) => u2(MonthAgendaDay, { setActiveDate, day, isActive: activeDate === day.date }, index + day.date)) });
}
function MonthAgendaDayNames({ week }) {
  ...
  return u2("div", { className: "sx__month-agenda-day-names", children: localizedShortDayNames.map((oneLetterDayName) => u2("div", { className: "sx__month-agenda-day-name", children: oneLetterDayName })) });
}
...
function MonthAgendaEvent({ calendarEvent }) {
  ...
  return u2("div", { className: "sx__event sx__month-agenda-event", "data-ccid": customComponentId, "data-event-id": calendarEvent.id, style: {
    ...
    borderLeft: customComponent ? void 0 : eventCSSVariables.borderLeft,
    padding: customComponent ? "0px" : void 0
  }, onClick: (e4) => onClick(e4), onKeyDown, tabIndex: 0, role: "button", children: [!customComponent && !hasCustomContent && u2(b, { children: [u2("div", { className: "sx__month-agenda-event__title", children: calendarEvent.title }), u2("div", { className: "sx__month-agenda-event__time sx__month-agenda-event__has-icon", children: [u2(TimeIcon, { strokeColor: `var(--sx-color-on-${calendarEvent._color}-container)` }), u2("div", { dangerouslySetInnerHTML: {
...
var MonthAgendaWrapper = ({ $app, id }) => {
  ...
  const [agendaMonth, setAgendaMonth] = h2(getMonth());
  y2(() => {
