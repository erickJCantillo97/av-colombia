...
interface EventsService extends PluginBase<string> {
    get(id: EventId): CalendarEventExternal | undefined;
    getAll(): CalendarEventExternal[];
    add(event: CalendarEventExternal): void;
    update(event: CalendarEventExternal): void;
...
declare class EventsServicePluginImpl implements EventsService {
    name: string;
    $app: CalendarAppSingleton;
    eventsFacade: EventsFacade;
    beforeRender($app: CalendarAppSingleton): void;
...
declare const createEventsServicePlugin: () => EventsServicePluginImpl & {
    name: "eventsService";
};
