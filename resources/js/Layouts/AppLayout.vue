...
<template>
  <div>
    ...
    <div class="bg-white overflow-x-hidden min-h-screen">
      ...
      <div
        id="docs-sidebar"
        class="hs-overlay [--auto-close:lg] hs-overlay-open:translate-x-0 -translate-x-full transition-all duration-300 transform hidden fixed top-0 start-0 bottom-0 z-[60] pt-2 overflow-y-auto lg:block lg:translate-x-0 lg:end-auto lg:bottom-0 [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300"
        :class="isMenuCollapsed ? 'w-20' : 'w-72'"
      >
      ...
      <main
        ...
        :class="isMenuCollapsed ? 'lg:ml-20' : 'lg:ml-72'"
      >
        <slot />
      </main>
    </div>
