    ...
    <form class="w-full flex justify-between gap-x-4" @submit.prevent="bookingServicesProveedors.submit">
        <IftaLabel class="w-full">
            <Select
              :options="proveedors"
              inputId="proveedor"
              @change="bookingServicesProveedors.calculateCost()"
              v-model="bookingServicesProveedors.form.p"
              variant="filled"
        ...
        <IftaLabel class="w-full">
            <InputNumber  v-model="bookingServicesProveedors.form.cost"  inputId="price_input" mode="currency" currency="USD" locale="en-US" variant="filled" class="w-full" />
