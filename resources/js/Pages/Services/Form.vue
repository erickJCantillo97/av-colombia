                    ...
                    <TabPanel value="0">
                        <div class="gap-y-4 flex flex-col">
                            <div class="w-full  gap-4 grid grid-cols-3">
                                ...
                                <Input label="Código de Referencia" class="w-full" v-model="form.code"
                                ...
                                <div>
                                    <label for="multiple-ac-2" class="font-bold block">Lugares de Visita
                                        (Destino)</label>
                                    <AutoComplete v-model="form.destinations" inputId="multiple-ac-2" multiple fluid
                                        :typeahead="false" />
                                </div>
                                ...
                                <Input v-if="form.duration_type != 'Valido en fecha de Reserva'" type="number"
                                    label="Valido por" v-model="form.duration" />
                                <Input v-if="form.duration_type != 'Valido en fecha de Reserva'"
                                    label="Unidad de tiempo" class="w-full" v-model="form.duration_unit"
                                    :error-message="form.errors.duration_type" type="dropdown" :options="[
                                        'Dias',
                                        'Horas',
                                        'Minutos'
                                ...
                                <Input type="number" label="Capacidad maxima" v-model="form.capacidad_max"
                        ...
                        <div class="flex gap-x-4 mt-8 justify-between">
                            ...
                            <Button @click="submit" title="Save" severity="success" :loading="form.processing"
                                ...
                                <div class="w-full shadow-md p-2 rounded-md">
                                    <div class="flex space-x-2 overflow-y-auto w-full">
                                        <AutoComplete @complete="search(true)"
                                            ...
                                            :suggestions="includeSuggestions" dropdown @keyup.enter="addRecogidas"
                                            v-model="recogidaName" class="w-full" pt:root="!w-full"
                                            pt:inputText="!w-full" />
                                    ...
                                    <div v-for="(feature, index) in form.recogidas"
                                        ...
                                        <span @click="removeRecogidas(index)" v-tooltip="'Quitar'"
                                            class="cursor-pointer"><i class="fa-solid fa-trash text-red-500"></i></span>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="w-full shadow-md p-2 rounded-md">
                                    <div class="flex space-x-2 overflow-y-auto w-full">
                                        <AutoComplete @complete="search(true)"
                                            ...
                                            :suggestions="includeSuggestions" dropdown @keyup.enter="addPuntos"
                                            v-model="puntosName" class="w-full" pt:root="!w-full"
                                            pt:inputText="!w-full" />
                                        <Button title="Añadir" @click="addPuntos" severity="primary" label="Añadir"
                                            icon="fa-solid fa-plus" class="!h-11" />
                                    </div>
                                    <div v-for="(feature, index) in form.puntos"
                                        ...
                                        <span @click="removePuntos(index)" v-tooltip="'Quitar'"
                                            class="cursor-pointer"><i class="fa-solid fa-trash text-red-500"></i></span>
                                    </div>
                                </div>
                            </div>
