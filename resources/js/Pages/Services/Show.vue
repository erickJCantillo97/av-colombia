                    ...
                    <div class="bg-white border rounded-2xl shadow-md p-6">
                        ...
                        <form class="mt-4 space-y-3">
                            ...
                            <div class="flex gap-2">
                                <!-- Check-in -->
                                <div class="w-full">
                                    <label class="text-xs font-medium  text-gray-700 block mb-1">{{service.type != 'EMBARCACION'?'LLEGADA':'FECHA'}}</label>
                                    <button type="button"
                                ...
                                <OverlayPanel ref="op" appendTo="body" class="!w-auto">
                                    <div class="p-0" v-if="service.type != 'EMBARCACION'">
                                    ...
                                    <div v-else>
                                        <VueDatePicker v-model="dateSingle" :min-date="new Date()" inline
                                            auto-apply :teleport="false" locale="es" :format="'dd/MM/yyyy'"
                                            :preview-format="'dd/MM/yyyy'" placeholder="Selecciona fechas"
                                            @update:model-value="handleCalendarChange" />
                                    </div>
