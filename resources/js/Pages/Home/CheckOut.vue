<template>
  ...
  <div class="bg-gray-50 py-10">
    <div class="m-auto max-w-2xl px-4 pb-24 pt-16 sm:px-6 lg:max-w-7xl lg:px-8">
      ...
      <form class="lg:grid lg:grid-cols-2 lg:gap-x-12 xl:gap-x-16">
        <div>
          ...
          <div class="mt-10 border-t border-gray-200 pt-10">
            <h2 class="text-lg font-medium text-gray-900">Información del pasajero</h2>
            ...
            <div class="mt-4 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-4">
              ...
              <div class="sm:col-span-2">
                <label for="company" class="block text-sm/6 font-medium text-gray-700"
                  >Hotel</label
                >
                <div class="mt-2">
                  <input
          ...
          <div class="mt-10 border-t border-gray-200 pt-10">
              ...
              <div class="space-y-4 sm:flex sm:items-center sm:space-x-10 sm:space-y-0">
                ...
                >
                  ...
                  <label
                    ...
                    class="ml-3 block text-sm/6 font-medium text-gray-700"
            ...
            <div class="mt-6 grid grid-cols-4 gap-x-4 gap-y-6">
              ...
              <div>
                <label for="cvc" class="block text-sm/6 font-medium text-gray-700"
                  >CVC</label
                >
                <div class="mt-2">
                  <input
          ...
          <div class="mt-4 rounded-lg border border-gray-200 bg-white shadow-sm">
            ...
            <ul role="list" class="divide-y divide-gray-200">
              <li
                ...
                :key="product.id"
                class="flex px-4 py-6 sm:px-2"
              >
                <div class="ml-6 flex flex-1 flex-col">
                  <div class="flex">
                    <div class="min-w-0 flex-1">
                      <h4 class="text-sm">
                        <apan class="font-medium text-gray-700 hover:text-gray-800">{{
                          product.title
                        }}</apan>
                      </h4>
