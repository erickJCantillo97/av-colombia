<template>
    <div class="relative isolate  mt-4">
        <div class="mx-auto grid max-w-7xl grid-cols-1 lg:grid-cols-2">
            <div class="relative px-6 py-12 sm:pt-32 lg:static lg:px-8 lg:py-20">
                <div class="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
                    ...
                    <h2 class="text-pretty text-4xl font-semibold tracking-tight text-gray-900 sm:text-5xl">Contacta con
                        nosotros
                    </h2>
                    <p class="mt-6 text-lg/8 text-gray-600">¿Tienes alguna pregunta o comentario? ¡Estamos aquí para
                        ayudarte! Rellena el formulario y te responderemos lo antes posible.
                    </p>
            ...
            <form action="#" method="POST" class="px-6 py-12 sm:pt-32 lg:static lg:px-8 lg:py-20">
                <div class="mx-auto max-w-xl lg:mr-0 lg:max-w-lg">
                    <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2">
                        <div>
                            <label for="first-name" class="block text-sm/6 font-semibold text-gray-900">Nombre</label>
                            <div class="mt-2.5">
                                <input type="text" placeholder="Escribe tu nombre" name="first-name" id="first-name"
                        ...
                        <div>
                            ...
                            <div class="mt-2.5">
                                <input type="text" placeholder="Escribe tu apellido" name="last-name" id="last-name"
                                    autocomplete="family-name"
                                    class="block w-full rounded-md bg-white px-3.5 py-2 text-base text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600" />
                            </div>
                        </div>
                        <div class="sm:col-span-2">
                            <label for="email" class="block text-sm/6 font-semibold text-gray-900">Correo
                                Electronico</label>
                            <div class="mt-2.5">
                        ...
                        <div class="sm:col-span-2">
                            <label for="phone-number" class="block text-sm/6 font-semibold text-gray-900">Telefono
                                (Opcional)</label>
                            <div class="mt-2.5">
                                <input placeholder="Escribe tu telefono para ponernos en contacto" type="tel"
                                    name="phone-number" id="phone-number" autocomplete="tel"
                                    class="block w-full rounded-md bg-white px-3.5 py-2 text-base text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600" />
                            </div>
                        </div>
                        <div class="sm:col-span-2">
                            ...
                            <div class="mt-2.5">
                                <textarea name="message" placeholder="Escribenos un mensaje" id="message" rows="4"
                                    class="block w-full rounded-md bg-white px-3.5 py-2 text-base text-gray-900 outline outline-1 -outline-offset-1 outline-gray-300 placeholder:text-gray-400 focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-indigo-600" />
                            </div>
                        </div>
                    </div>
