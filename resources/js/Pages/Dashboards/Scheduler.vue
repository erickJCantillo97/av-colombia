                    ...
                    <div class="overview-content">
                        <div class="left-panel">
                            <div class="overview-scheduler">
                                <ejs-schedule id='scheduler' ref="scheduleObj" height="100%"
                                    cssClass='schedule-overview' :currentView='currentView' timezone='UTC'
                                    ...
                                    <e-resources>
                                        <e-resource field="CalendarId" title="Calendars"
                                            :dataSource="resourceDataSource" :query='resourceQuery'
...
export default {
    ...
    data: function () {
        return {
            ...
            allowMultiple: true,
            liveTimeUpdate: new Date().toLocaleTimeString('en-US', { timeZone: 'America/Bogota' }),
            showFileList: false,
            multiple: false,
