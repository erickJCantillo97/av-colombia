<template>
  <div :class="[
    ...
    <div class="w-px h-8 bg-gray-200 divider-animated"></div>
    <div class="flex-1 relative search-section" @click="setActiveTab('checkout')"
      :class="['px-6 py-4 cursor-pointer transition-all duration-200 modern-focus', activeTab === 'checkout' ? 'bg-white shadow-md section-active' : 'hover:bg-gray-50']">
