  ...
  <Transition name="panel">
    <div v-if="isPanelOpen"
      ...
      <div v-if="activeTab === 'donde'" class="p-4 sm:p-8 panel-content">
        ...
        <div class="relative mb-4 sm:mb-6">
          ...
          <input :value="locationQuery"
            @input="$emit('update:locationQuery', $event.target.value); $emit('searchLocations')" type="text"
      ...
      <div v-if="activeTab === 'checkout'" class="p-4 sm:p-8 panel-content">
        ...
        <div
          class="border border-gray-200 rounded-lg p-4 sm:p-6 cursor-pointer hover:border-gray-300 transition-all duration-200 text-center scale-hover modern-focus"
