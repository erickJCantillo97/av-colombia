  ...
  <Transition name="panel">
    <div v-if="isPanelOpen"
      ...
      <div v-if="activeTab === 'donde'" class="p-4 sm:p-8 panel-content">
        ...
        <div>
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            >
              <div class="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-r from-blue-100 to-blue-200 rounded-lg flex items-center justify-center flex-shrink-0">
      ...
      <div v-if="activeTab === 'checkin'" class="p-4 sm:p-8 panel-content">
        <h3 class="text-lg font-semibold text-gray-900 mb-4 sm:mb-6">¿Cuándo es tu viaje?</h3>
        <div>
          <CalendarSelector
            class="w-full"
      ...
      <div v-if="activeTab === 'checkout'" class="p-4 sm:p-8 panel-content">
        ...
        <div class="border border-gray-200 rounded-lg p-4 sm:p-6 cursor-pointer hover:border-gray-300 transition-all duration-200 text-center scale-hover modern-focus"
          ...
          <div v-if="selectedCheckout" class="text-gray-900 font-medium text-base sm:text-lg">{{ formatDate(selectedCheckout) }}</div>
