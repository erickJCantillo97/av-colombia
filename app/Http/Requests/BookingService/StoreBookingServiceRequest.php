...
class StoreBookingServiceRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'adults_nacionales' => 'nullable|numeric|min:0',
            'adults_extranjeros' => 'nullable|numeric|min:0',
            'boys' => 'nullable|numeric',
            'boys_nacionales' => 'nullable|numeric|min:0',
            'boys_extranjeros' => 'nullable|numeric|min:0',
